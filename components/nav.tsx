      ...
      <Popover>
        ...
        <PopoverContent>
          <ul className="flex pointer-events-auto font-medium flex-col gap-4 font-base">
            <li>
              <Link href="mailto:yathishgp1@gmail.com">email</Link>
            </li>
            <li>
              <Link href="tel:+919844914810">phone</Link>
            </li>
            <li>
              <Link href="https://linkedin.com/in/yathishgp003">
                linkedin
              </Link>
            </li>
            <li>
              <Link href="https://x.com/yathishgp003">x.com</Link>
            </li>
          </ul>
        </PopoverContent>
      </Popover>
